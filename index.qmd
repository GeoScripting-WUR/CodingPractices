...
For smaller projects (< 5) functions, all functions can go in 1 script.
For bigger projects functions are stored in multiple files, split by functionality.
...
In R you would write `source(R/myFunction.R)`, in python you would write `from floodmapping import *`
